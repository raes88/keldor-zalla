...
app.post('/user', function(req, res) {
    ...
    mysql.crearUsuario(nuevoUsuario)
        .then(function(usuarios) {
            res.send(usuarios)
        })
...
app.put('/user/:id', function(req, res) {
    ...
    mysql.remplazarUsuario(id, remplazarUsuario)
        .then(function(usuarios) {
            res.send(usuarios)
        })
...
app.patch('/user/:id', function(req, res) {
    ...
    let rempParteUsuario = req.body
     mysql.rempParteUsuario(id, rempParteUsuario)
        .then(function(usuarios) {
            res.send(usuarios)
        })
